...
const uint8_t* digit2text_array[11] = {digit_0, digit_1, digit_2, digit_3, digit_4, digit_5, 
                                  digit_6, digit_7, digit_8, digit_9, digit_colon};
static uint8_t digit_array[6];
static bool digit_array_carry[6] = {false, false, false, false, false, false};
static uint8_t* text_array[8];
text_array[2] = text_array[5] = digit2text_array[10];
bool check_carry()
{
  for(int i = 0; i<6; i++) if(digit_array_carry[i] == true) return i;
  return 6;
}
